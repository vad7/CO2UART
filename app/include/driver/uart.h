...
#define UART0   0 // TXD - pin26
#define UART1   1 // TXD - GPIO2
//#define USE_UART1 // if omitted only UART0 will been used
...
typedef void uart_recieve_func(os_event_t *events);

#ifdef USE_UART1
void uart_init(UartBautRate uart0_br, UartBautRate uart1_br, uart_recieve_func * rx_task) ICACHE_FLASH_ATTR;
#else
void uart_init(UartBautRate uart0_br, uart_recieve_func * rx_task) ICACHE_FLASH_ATTR;
#endif
